...
def instructions(win):
    ...
    text_rect = text1.get_rect(center=(WIDTH/2, 25))
    win.blit(text1, text_rect)
    text_rect = text2.get_rect(center=(WIDTH/2, 90))
    win.blit(text2, text_rect)
    text_rect = text3.get_rect(center=(WIDTH/2, 120))
    win.blit(text3, text_rect)
    text_rect = text4.get_rect(center=(WIDTH/2, 150))
    win.blit(text4, text_rect)
    text_rect = text5.get_rect(center=(WIDTH/2, 180))
    win.blit(text5, text_rect)
    text_rect = text6.get_rect(center=(WIDTH/2, 210))
    win.blit(text6, text_rect)
    text_rect = text7.get_rect(center=(WIDTH/2, 270))
    win.blit(text7, text_rect)
    text_rect = text8.get_rect(center=(WIDTH/2, 300))
    win.blit(text8, text_rect)
    text_rect = text9.get_rect(center=(WIDTH/2, 330))
    win.blit(text9, text_rect)
    text_rect = text10.get_rect(center=(WIDTH/2, 360))
    win.blit(text10, text_rect)
    text_rect = text11.get_rect(center=(WIDTH/2, 410))
    win.blit(text11, text_rect)
    text_rect = text12.get_rect(center=(WIDTH/2, 440))
    win.blit(text12, text_rect)
    text_rect = text13.get_rect(center=(WIDTH/2, 470))
    win.blit(text13, text_rect)
    text_rect = text14.get_rect(center=(WIDTH/2, 600))
    win.blit(text14, text_rect)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_SPACE and start and end and not instruct:
                    ...
                    Algorithm(lambda: draw(win, grid, ROWS, width, Distance, Time, Operations, algorithm, instruct), grid , start, end, algorithm)
                # Clear window
